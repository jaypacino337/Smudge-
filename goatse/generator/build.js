#!/usr/bin/env node
/**
 * GOATSE — generative build engine
 *
 *   npm run build -- 2222       full collection: images + metadata + rarity report
...
// Exported so other tools (make-showcase) can check a hand-picked combination against
// the same rules the collection is generated under, instead of duplicating the grammar.
module.exports = { tokenMatches, violatesExclusions };
